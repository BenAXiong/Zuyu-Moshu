...
Global timestamp: 2026-06-04 17:42 +08:00
...
- Saved items are local to the current Chrome profile/device in v1.5.3. Cross-device sync/export is not implemented yet.
